...
impl Shape for King {
    fn draw(&self, painter: &mut Painter) {
        ...
        let lines = [
            Line::new(left_top_x, left_top_y, left_bottom_x, left_bottom_y, self.color),
            Line::new(right_top_x, right_top_y, left_middle_x, left_middle_y, self.color),
            Line::new(right_bottom_x, right_bottom_y, left_middle_x, left_middle_y, self.color),
        ];
